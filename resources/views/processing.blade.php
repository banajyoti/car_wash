...
<body>
    ...
    <div class="row mt-4">
      ...
      <div class="col-md-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">$10 / Wash</h5>
            ...
            <div class="input-group mb-3">
              ...
              <button class="btn btn-outline-primary" type="button" id="searchBasicBtn">Search</button>
            </div>
      ...
      <div class="modal fade" id="searchResultModal" tabindex="-1" aria-labelledby="searchResultModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <form method="POST" action="{{ route('submit.premium.selection') }}">
            @csrf
            <input type="text" name="customer_id" id="modalCustomerId">

            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Confirm Premium Plan</h5>
              ...
              <div class="modal-body">
                ...
                <div class="mb-3">
                <label class="form-label">Sagment</label>
  ...
  <script>
            ...
            response.forEach(user => {
              html += `<div class="border p-2 mb-2">
                ...
                <button type="button" class="btn btn-sm btn-primary mt-2"
                  onclick="selectCustomer('${user.id}', '${user.name}', '${user.phone}', '${user.car_no}')">
                  Select Customer
                </button>
              </div>`;
            });
    ...
    function selectCustomer(id, name, phone, carNo) {
      // Set hidden field
